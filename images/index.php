...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="reddit.css"/>
	...
	<body>
		...
		<div id="imageframe">
			<a id="imagelink" href="<?php echo $selectedImage ?>">
				<img id="image" alt="loadin'" src="<?php echo $selectedImage ?>"></img>
			</a>
			
		</div>
		<script type='text/javascript' src='switchImageSource.js'></script>
